...
public class ItemBbsController {
	   ...
	   public void itemDetail(ItemBbs itemDto) {
		   List<Category> categoryList = categoryService.getAllCategories(0);
		   System.out.println("ITEMDETAIL.GETCATEGORY_ID : "+itemDto.getCategory_id());
		   Category categoryDto = categoryService.categorySearchName(itemDto.getCategory_id());
		   new ItemDetail(itemDto, categoryList,categoryDto);
	   }
